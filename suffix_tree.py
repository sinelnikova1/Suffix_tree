#Ответственные: 
#Синельникова Анастасия - построение суф. дерева
#Исмаилова Эля - подключение твиттера
#Сдобникова Анна - реализация функций: поиск, является ли подстрокой, самая длинная подстрока, самая часто встречающаяся
